...
gcc -fno-stack-protector -m32 -g -c src/kernel.c -o kernel.o -ffreestanding -Wpedantic
gcc -fno-stack-protector -m32 -g -c src/video.c -o video.o -ffreestanding -Wpedantic
gcc -fno-stack-protector -m32 -g -c src/common.c -o common.o -ffreestanding -Wpedantic
gcc -fno-stack-protector -m32 -g -c src/system.c -o system.o -ffreestanding -Wpedantic
gcc -fno-stack-protector -m32 -g -c src/time.c -o time.o -ffreestanding -Wpedantic
gcc -fno-stack-protector -m32 -g -c src/keyboard.c -o kb.o -ffreestanding -Wpedantic
...
ld -m elf_i386 -T misc/link.ld -g -o bin/kernel.elf kasm.o kernel.o video.o common.o system.o time.o kb.o
